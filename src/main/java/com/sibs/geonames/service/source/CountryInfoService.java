...
public class CountryInfoService {
    ...
    @Async
    public CompletableFuture<Map> searchCountryInfo(String countryId){

        Map<String, Object> countryInfoConfiguration = (Map<String, Object>) sourcesConfiguration.getSources().get("countryInfo");
